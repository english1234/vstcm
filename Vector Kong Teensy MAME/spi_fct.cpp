...
//static uint32_t mytcr; //Keeps track of what the TCR register should be put back to after 16 bit mode - bit of a hack but reads and writes are a bit funny for this register (FIFOs?)
//static uint32_t mytcr1; 
...
extern "C" void SPI_flush(void);    // make it possible to call this function from a .c file
